  ...
  return (
    ...
    >
      <div>
        <div className="mb-12">
          <div>
            <p className="section-label text-lightbrown">Our Work</p>
        ...
        <div className="mt-10 columns-1 md:columns-2 lg:columns-3 gap-8">
          <div className="relative">
            <img className="w-full mb-8 aspect-video object-cover" src={kitchenShelf} alt="Wood Shelf" loading="lazy" />
            <p className="font-semibold text-lightbrown/60 text-lg bg-darkbrown px-4 py-2 absolute bottom-0 left-0">
              Kitchen Shelf
            </p>
          </div>
          <div className="relative">
            <img
              className="w-full mb-8 aspect-square object-cover"
              src={bathroomVanity}
              alt="Bathroom Vanity"
              loading="lazy"
            />
          ...
          <div className="relative">
            <img className="w-full mb-8 aspect-video object-cover" src={coffeeTable} alt="Coffee Table" loading="lazy" />
            <p className="font-semibold text-lightbrown/60 text-lg bg-darkbrown px-4 py-2 absolute bottom-0 left-0">
              Coffee Table
            </p>
          </div>
          ...
          <div className="relative">
            <img className="w-full mb-8 aspect-video object-cover" src={cuttingBoard} alt="Cutting Board" loading="lazy" />
            <p className="font-semibold text-lightbrown/60 text-lg bg-darkbrown px-4 py-2 absolute bottom-0 left-0">
              Cutting Board
            </p>
          </div>
          ...
          <div className="relative">
            <img
              className="w-full mb-8 aspect-video object-cover object-top"
              src={stepStool}
              alt="Step Stool"
              loading="lazy"
            />
