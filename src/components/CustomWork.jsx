  ...
  return (
    <section className="py-28 px-12">
      <div className="max-w-screen-2xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 items-center border-t border-dark-muted/30 pt-12 mt-12">
          <div className="text-start">
            <h2 className="font-heading font-bold text-3xl">Have a custom project in mind?</h2>
            <p className="text-dark-mid/80 text-lg">Let us know how we can help!</p>
          </div>
