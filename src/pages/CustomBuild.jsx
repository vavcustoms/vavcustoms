  ...
  return (
    <>
        ...
        <div className="max-w-screen-2xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24">
            <div>
              ...
              <form>
                <div className="mb-6">
                  <label htmlFor="name" className="block font-mono text-darkbrown/80 text-xs tracking-widest uppercase mb-2">
                    Name
                  </label>
                  <input
                    type="text"
                    id="name"
                    className="block w-full py-3 px-4 border border-b-2 border-darkbrown/30 text-sm focus:outline-none focus:border-b-darkbrown/70 transition duration-150 ease-in-out"
                ...
                <div className="mb-6">
                  <label
                    htmlFor="email"
                    className="block font-mono text-darkbrown/80 text-xs tracking-widest uppercase mb-2"
                  >
                    Email
                  </label>
                  <input
                ...
                <div className="mb-6">
                  ...
                  <textarea
                    id="message"
                    className="block w-full h-68 py-3 px-4 border border-b-2 border-darkbrown/30 text-sm focus:outline-none focus:border-b-darkbrown/70 transition duration-150 ease-in-out"
                ...
                <div className="mb-6">
                  ...
                  <input
                    id="image"
                    type="file"
                    className="block w-full py-3 px-4 text-sm border border-b-2 border-darkbrown/30 file:bg-lightbrown file:text-darkbrown/80 file:text-xs file:px-4 file:py-1 file:border-none file:rounded-full focus:outline-none focus:border-b-darkbrown/70 transition duration-150 ease-in-out"
                  />
                </div>
            ...
            <div>
              ...
              <div className="py-8 border-b border-lightbrown">
                <p className="font-mono text-xs text-brand-600 tracking-widest mb-3">01</p>
                <h3 className="font-heading font-bold text-xl mb-2.5">Uniquely Yours</h3>
                <p className="text-sm text-darkbrown/70 leading-7">
              ...
              <div className="py-8 border-b border-lightbrown">
                <p className="font-mono text-xs text-brand-600 tracking-widest mb-3">02</p>
              ...
              <div className="py-8 border-b border-lightbrown">
                <p className="font-mono text-xs text-brand-600 tracking-widest mb-3">03</p>
      ...
      <section className="py-28 px-12 bg-darkbrown">
        <div className="max-w-screen-2xl mx-auto">
          <h2 className="section-title text-warmwhite mb-12">Custom Build Examples</h2>
